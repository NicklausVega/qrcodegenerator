...
// Removed useChart function as it's not used in the simplified version
...
function ChartLegendContent(props: React.ComponentProps<typeof RechartsPrimitive.Legend>) {
